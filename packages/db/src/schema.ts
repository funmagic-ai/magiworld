 ...
 *
 * Stores chat conversation sessions for the Magi AI assistant.
 * Each conversation can have a different provider and model.
 */
export const chatConversations = pgTable('chat_conversations', {
  ...
  /** Model ID (gpt-4o-mini, gemini-2.0-flash, etc.) */
...
export const chatMessages = pgTable('chat_messages', {
  /** Unique identifier (UUID v4) */
  id: uuid('id').primaryKey().defaultRandom(),
  /** Reference to parent conversation (cascades on delete) */
...
/** Inferred select type for chat_conversations table */
export type ChatConversation = typeof chatConversations.$inferSelect;
/** Inferred insert type for chat_conversations table */
export type ChatConversationInsert = typeof chatConversations.$inferInsert;

/** Inferred select type for chat_messages table */
export type ChatMessage = typeof chatMessages.$inferSelect;
/** Inferred insert type for chat_messages table */
